            ...
            {searchRequestIsLoading || !searchResultsQuery.data ? (
              ...
              <div>
                <div className='flex justify-between pb-6'>
                  ...
                  <div
                    hidden={Object.keys(cleanObj(filterParams)).length === 0}
                  >
                    <UnstyledButton
                      fz='xs'
                ...
                <Stack>
                  ...
                  <div>
                    <Title order={3} fz={'h5'} mb={8}>
                      Tur Süresi <small className='text-gray-600'>(Gece)</small>
                    </Title>
                    <Checkbox.Group
                      onChange={(value) => {
                        setFilterParams({
                          nightCount: value.length ? value.map(Number) : null,
                        })
                      }}
                      value={
                  ...
                  <div>
                    ...
                    <Checkbox.Group
                      ...
                      value={filterParams.regions ? filterParams.regions : []}
                    >
                      <Stack gap={rem(6)}>
