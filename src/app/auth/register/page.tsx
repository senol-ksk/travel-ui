...
export default function RegisterPage() {
  ...
  return (
    <Container className=''>
      <div className='mt-5 grid grid-cols-1 gap-5 rounded-lg border shadow md:grid-cols-4'>
        <div className='col-span-2 hidden rounded-l-lg border-r bg-blue-50 p-3 shadow md:block'>
