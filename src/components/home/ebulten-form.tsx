...
import { TextInput, Button, Text, Box, Container } from '@mantine/core'

const EbultenForm = () => {
  return (
    <Container>
      <Box className='mx-auto mt-10 max-w-7xl rounded-2xl bg-blue-700 p-6 text-white shadow-lg md:p-10'>
